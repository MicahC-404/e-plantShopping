...
function ProductList({ onHomeClick }) {
    ...
    // Task 4: Retrieve cart items from Redux store to track global state
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    description: "Known for its beautiful fragrance and colors.",
                    cost: "$22"
                }
            ]
        },
    ...
    // Task 4: Calculate total number of items in the cart
                        ...
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                <div style={{position: 'relative'}}>
                                    ...
                                    {/* Displaying the total quantity badge */}
